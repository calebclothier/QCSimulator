...
""" Most of code from fourFn.py pyparsing example, altered to work with variables """

class VariableMathStringParser(object):
    ...
    def __init__(self):
        ...
        expr = Forward()
        atom = ((Optional(oneOf("- +")) +
                 (ident + lpar + expr + rpar | pi | e | fnumber | variable).setParseAction(self.pushFirst))
